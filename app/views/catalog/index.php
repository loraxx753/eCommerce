					...
					<div class="span9">
						...
						<?php
							...
							{?>	
								<div class="span2 catalog_item">
								<ul class="thumbnail">
								<li><?=Load::image($value->Product_Image."_thumbnail.jpg", "Chairs")?></li>	
								<li><?=Load::link(array('product/'.$value->ProductID => $value->Product_Name))?></li>
								<li>$<?=number_format($value->Product_Price,2)?></li>
								</ul>
								</div>
							<?php }?>
					</div>
