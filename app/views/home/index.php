					...
					<div class="span12 featured">
						...
						<?php
							...
							{?>
								<div class="span2 catalog_item">
								<ul class="thumbnail">
								<li><?=Load::image($top[$x]->Product_Image.'_thumbnail.jpg', $top[$x]->Product_Name)?></li>
								<li><?=Load::link(array('product/'.$top[$x]->ProductID => $top[$x]->Product_Name))?></li>
								<li>$<?=number_format($top[$x]->Product_Price, 2)?></li>
								</ul>
								</div> 
						<?php }?>
					</div>
					<div class="span12 featured">
						...
						<?php
							...
							{?>
								<div class="span2 catalog_item">
								<ul class="thumbnail">
								<li><?=Load::image($new[$x]->Product_Image.'_thumbnail.jpg', $new[$x]->Product_Name)?></li>
								<li><?=Load::link(array('product/'.$new[$x]->ProductID => $new[$x]->Product_Name))?></li>
								<li><?=number_format($new[$x]->Product_Price, 2)?></li>
								</ul>
								</div> 
						<?php }?>	
					</div>
