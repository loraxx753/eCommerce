		...
		public static function action_fill()
		{
			$queryArray = array(
					array("INSERT INTO `Products` (`SKU`, `Product_Name`, `Product_Description`, `Category_ID`, `Stock`, `Product_Cost`, `Product_Price`, `Product_Image`, `Product_Weight`, `Product_Size`, `Featured`, `Sale_Price`) VALUES
						(1, 'Red Thinking Chair', 'chair', 1, 5, 50, 100, 'products/chair', 20, '10x11x12', 0, NULL),
						(2, 'Napoleon Chair', 'chair', 1, 5, 60, 100, 'products/chair2', 40, '10x11x12', 1, NULL),
						(3, 'Wooden Chair', 'chair', 1, 5, 40, 100, 'products/chair3', 10, '10x11x12', 0, NULL),
						(4, 'Thinking Couch', 'couch', 2, 5, 80, 100, 'products/couch1', 50, '20x21x22', 0, NULL),
						(5, 'Chic Couch', 'couch', 2, 5, 90, 100, 'products/couch2', 60, '20x21x22', 0, NULL),
						(6, 'Viewing Couch', 'couch', 2, 5, 80, 100, 'products/couch3', 60, '20x21x22', 0, NULL),
						(7, 'Resting Couch', 'couch', 2, 5, 90, 100, 'products/couch4', 60, '20x21x22', 0, NULL),
						(8, 'Apple Desk', 'desk', 3, 5, 70, 100, 'products/desk', 40, '30x31x32', 0, NULL),
						(9, 'Writing Desk', 'desk', 3, 5, 80, 100, 'products/desk2', 90, '30x31x32', 0, NULL),
						(10, 'Computer Desk', 'desk', 3, 5, 60, 100, 'products/desk3', 40, '30x31x32', 0, NULL);
